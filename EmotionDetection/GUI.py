...
class Evaluator():
    def __init__(self):
        ...
        tk.Button(main, text='Clear', command=self.clearButton, font=(None, 10)).grid(row=2, column=0, stick="nsew", pady=(8, 2), padx=10)
        tk.Button(main, text='Quit',command=main.destroy, font=(None, 10)).grid(row=3, column=0, sticky="nsew", pady=(2, 8), padx=10)
        tk.Button(main, text='Predict', command=self.predButton,fg='white',bg='blue',font=(None, 15)).grid(row=2, column=1, rowspan=2, sticky="nsew", pady=9, padx=20)
